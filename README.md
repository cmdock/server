...
cmdock-server admin sync create <user-id>           # Canonical sync identity/secret for gateway devices
cmdock-server admin device create <user-id> --name "Work iPhone" --server-url https://tasks.example.com
