...
pub const VIEWSET_VERSION: i32 = 4;
...
pub fn default_views() -> Vec<ViewRecord> {
    vec![
        ...
        ViewRecord {
            ...
            filter: "status:pending project:PERSONAL".to_string(),
        ...
        ViewRecord {
            ...
            filter: "status:pending project:HEALTH".to_string(),
            group_by: None,
            context_filtered: false,
            display_mode: "list".to_string(),
            sort_order: 50,
...
mod tests {
    ...
    #[test]
    fn test_cross_cutting_defaults_are_context_filtered() {
        let views = default_views();
        ...
        assert!(
            duesoon.context_filtered,
            "duesoon should support context filtering"
        );
        assert!(
            action.context_filtered,
            "action should support context filtering"
        );
        assert!(
            !personal.context_filtered,
            "named context views should remain non-context-filtered"
        );
    }
