...
#[schema(example = json!({
    ...
    "mergedSync": {
        "journalStateCounts": [{"state": "finalized", "count": 3}],
        "recentJournal": [{
            "journalId": "aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa",
            "clientId": "tw-client-1",
            "gatewayAttemptId": "bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb",
            "parentVersionId": "00000000-0000-0000-0000-000000000000",
            "mergedVersionId": "cccccccc-cccc-4ccc-8ccc-cccccccccccc",
            "state": "finalized",
            ...
            "finalizedAt": "2026-04-02T10:00:01.000Z"
        }]
    },
    "integrityCheck": {
        "replica": "ok",
...
pub struct UserStats {
    ...
    pub merged_sync: MergedSyncDiagnostics,
...
#[derive(Serialize, ToSchema)]
#[serde(rename_all = "camelCase")]
pub struct MergedSyncDiagnostics {
    pub journal_state_counts: Vec<MergedSyncJournalStateCountResponse>,
    pub recent_journal: Vec<MergedSyncJournalResponse>,
}

#[derive(Serialize, ToSchema)]
#[serde(rename_all = "camelCase")]
pub struct MergedSyncJournalStateCountResponse {
    pub state: String,
    pub count: i64,
}
...
#[derive(Serialize, ToSchema)]
#[serde(rename_all = "camelCase")]
pub struct MergedSyncJournalResponse {
